        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Bewerk Informatie</h3>
            </div>
            <!-- /.box-header -->
            <form role="form" action="<?php base_url('users/setting') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="radio">
                    ...
                    <label>
                      <input type="radio" name="gender" id="neutraal" value="3" <?php if($user_data['gender'] == 3) {
                        echo "checked";
                      } ?>>
                      Gender neutraal
                    </label>
                ...
                <div class="form-group">
                  <div class="alert alert-info alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                      Laat het wachtwoorden veld leeg, als je deze niet wilt veranderen
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="cpassword">Verifieer wachtwoord</label>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('users/') ?>" class="btn btn-warning">Terug</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
