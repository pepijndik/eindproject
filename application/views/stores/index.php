...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Beheer
      <small>Uitgifte punten</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Uitgifte punt</li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if (in_array('createStore', $user_permission)) : ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Voeg uitgifte punt toe</button>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Beheer uitgifte punten</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Voeg uitgifte punt toe</h4>
        </div>
        ...
        <form role="form" action="<?php echo base_url('stores/create') ?>" method="post" id="createForm">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="brand_name">Uitgifte punt naam</label>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary">Sla veranderingen op</button>
          </div>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="editModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Verander Uitgifte punt</h4>
        </div>
        ...
        <form role="form" action="<?php echo base_url('stores/update') ?>" method="post" id="updateForm">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="edit_brand_name">Uitgifte punt Naam</label>
              <input type="text" class="form-control" id="edit_store_name" name="edit_store_name" placeholder="Uitgifte naam" autocomplete="off">
            </div>
            <div class="form-group">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Verwijder uitgifte punt</h4>
        </div>
