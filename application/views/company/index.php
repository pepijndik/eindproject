      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Beheer bedrijf Informatie</h3>
          </div>
          <form role="form" action="<?php base_url('company/update') ?>" method="post">
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="company_name">Bedrijf Naam</label>
              ...
              <div class="form-group">
                <label for="company_name">Factuur prefix</label>
                <input type="text" class="form-control" id="invoice_prefix" name="invoice_prefix" placeholder="Enter invoice prefix" value="<?php echo $company_data['invoice_prefix'] ?>" autocomplete="off">
              </div>
              <div class="form-group">
                <label for="service_charge_value">Service kosten (%)</label>
              ...
              <div class="form-group">
                <label for="vat_charge_value">Btw(%)</label>
              ...
              <div class="form-group">
                <label for="phone">Telefoor nummer</label>
              ...
              <div class="form-group">
                <label for="permission">Bericht</label>
